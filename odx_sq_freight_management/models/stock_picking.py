...
class StockPicking(models.Model):
    ...
    def generate_freight(self):
        if self.env.user.has_group('odx_sq_freight_management.group_frm_view_access'):
            ...
            for operation in self.move_ids_without_package:
                ...
                vals['cargo_lines'].append((0, 0, {
                    ...
                    'category_id': operation.category_id and operation.category_id.id,
                    'product_classificaton': operation.product_classificaton,
