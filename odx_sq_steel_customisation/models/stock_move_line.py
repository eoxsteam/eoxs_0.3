            ...
            if self.qty_done > 0:
                ...
                lot_a = self.env['stock.production.lot']. \
                    ...
                    {'name': str(sequence),
                     ...
                     'thk_in':self.move_id.thk_in,
                     'width_in':self.move_id.width_in,
                     'cut_l_in':self.move_id.cut_l_in,
                     'od_in':self.move_id.od_in,
                     'length_in':self.move_id.length_in,
                     'weight_lb':self.move_id.weight_lb,
                ...
                lot_a._onchange_cut_l()
                lot_a._onchange_weight()
                lot_a._onchange_od()
